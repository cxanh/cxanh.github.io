...
function createtime() {
  ...
  var start = new Date("07/31/2004 00:00:00"); // 旅行者1号开始计算的时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.shields.io/badge/摸鱼了-营业中-6adea8?style=social&logo=cakephp' title='你也是来摸鱼的吗，分你一条~' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/天晚了-我先睡啦-6adea8?style=social&logo=coffeescript' title='这个点了应该去睡觉啦，熬夜对身体不好哦' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    ...
    --darkmode-bg:url(https://v-storage.hitokoto.cn/2022/2023_Hitokoto_Banner.jpg);
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://v-storage.hitokoto.cn/2022/2023_Hitokoto_Banner.jpg)" class="imgbox" onclick="changeBg('url(https://v-storage.hitokoto.cn/2022/HitokotoBanner04-PC.jpg)')"></a></div>
              </div>
            </details>
